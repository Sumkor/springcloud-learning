...
import com.sumkor.cloud.controller.MyZuulController;
...
/**
 * 注册自定义的 ZuulController，修改 CounterFactory bean 配置，启动 allow-bean-definition-overriding
 *
 * @author Sumkor
 * @see ZuulServerAutoConfiguration
 */
@Configuration
...
public class MyZuulServerAutoConfiguration {
    ...
    public FilterRegistrationBean zuulServletFilter() {
        final FilterRegistrationBean<com.netflix.zuul.filters.ZuulServletFilter> filterRegistration = new FilterRegistrationBean<>();
        filterRegistration.setUrlPatterns(
                Collections.singleton(this.zuulProperties.getServletPattern()));
        filterRegistration.setFilter(new com.netflix.zuul.filters.ZuulServletFilter());
